...
$acc_username = "rodmxr";
$acc_password = "rodmar123";
$acc_fullname = "Rodmar Salvacion";
$acc_address = "Marinduque PH";
//checked the current url for the redirections later
...
if (isset($_REQUEST['login_button']) === true){
	...
	//if the username is wrong
		...
		//username and password is correct
			...
			header("Location: ".$url_add."?Loginsuccess");
				...
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			}else if (isset($_REQUEST['Loginsuccess'])===true){
